...
function multiCheck(o) {
    o.on("change", ".chk-parent", function() {
        var o = $(this).closest("table").find("td:first-child .child-chk"),
            n = $(this).is(":checked");
        $(o).each(function() {
            n ? ($(this).prop("checked", !0), $(this).closest("tr").addClass("active")) : ($(this).prop("checked", !1), $(this).closest("tr").removeClass("active"))
        })
...
function cDropdown(o) {
    for (var n = document.getElementsByClassName("c-dropdown-content"), e = 0; e < n.length; e++) n[e].classList.remove("show");
...
for (var classname = document.getElementsByClassName("c-dropbtn"), i = 0; i < classname.length; i++) classname[i].addEventListener("click", function() {
